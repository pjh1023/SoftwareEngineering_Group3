...
public class Player extends JPanel {
	...
	int[] xLocationsOfPlayer3 = {31, 131, 231, 331, 431, 531,
			531, 531, 531, 531, 531,
			431, 331, 231, 131, 31,
			31, 31, 31, 31};

	int[] yLocationsOfPlayer3 = {63, 63, 63, 63, 63, 63,
			163, 263, 363, 463, 563,
			563, 563, 563, 563, 563,
			463, 363, 263, 163};
	
	int[] xLocationsOfPlayer4 = {61, 191, 291, 361, 461, 561,
			561, 561, 561, 561, 561,
			461, 361, 261, 161, 61,
			61, 61, 61, 61};
	...
	public void move(int dicesTotal) {
		...
		if(ledger.containsKey(this.getCurrentSquareNumber())) {
			GameFrameTypePanel.infoConsole.setText("This property belongs to player "+ledger.get(this.getCurrentSquareNumber()));
		}
